...
# filtro publicaciones menores a 10 metros cuadrados totales

archivo_limp <- filter(archivo_limp, archivo_limp$TOTAL_AREA >= 10)

#casos han sido limpiados por tener metros cuadrados totales menores a 10
...
#------------------------guardado localidades--------------------------------------

# Crear la ruta de la carpeta dinámica y luego el archivo
...
#------------------combinar: hacerlo en el caso que nunca se unifico-----------------------------------------------#
#REVISAR RUTA DE SU COMPU
# traemos al combinado general.
archivo1 <- read.csv(
  "C:/Users/Usuario/Documents/R/SIVYS/ML/Resultados2/combinado_general_todos_los_meses/combinado.csv",
  fileEncoding = "UTF-8",
  stringsAsFactors = FALSE
)

archivo2 <- read.csv(
  paste0("C:/Users/Usuario/Documents/R/SIVYS/ML/Resultados2/combinado_por_mes/Localidades/", 
         mes, "_", anio, "/archivo_limp_sin_out_completo.csv"),
  fileEncoding = "UTF-8",
  stringsAsFactors = FALSE
)

combinado <- rbind(archivo1, archivo2)
